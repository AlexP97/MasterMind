    ...
    public void labelsMethod() {
        ...
        for(int row = 0; row < dif; row++) {
            ...
            for(int col = 0; col < num; col++) {
                ...
                label[row][col].setOpaque(false);
                label[row][col].setBounds(x, y, 32, 32);
                label[row][col].setIcon(iconoVacio);
                getContentPane().add(label[row][col]);
